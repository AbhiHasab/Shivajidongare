 ...
 */
public class vachannama extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vachannama);
        ...
        mycontact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(vachannama.this,
    ...
    protected void showList(){
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    vachannama.this, personList, R.layout.list_item,
                    new String[]{TAG_ID},
                    new int[]{R.id.id}
            );
    ...
    public void getData(){
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                String url="https://abhijeethasabe.000webhostapp.com/vad.php";
                Log.e("Lodin",url);
